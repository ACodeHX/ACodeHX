      ...
      >
        <title id="titleId">ACodeHX' GitHub Stats, Rank: A+</title>
        <desc id="descId">Total Stars Earned: 1, Total Commits in 2023 : 1, Total PRs: 1, Total Issues: 0, Contributed to (last year): 1</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 126.42610900333288;
      }
    }
